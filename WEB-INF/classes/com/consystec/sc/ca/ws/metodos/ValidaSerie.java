...
import com.consystec.sc.ca.ws.cliente.InventarioCliente;
...
import com.consystec.sc.sv.ws.metodos.CtrlValidaArticulos;

public class ValidaSerie extends ControladorBase {

    String TOKEN = "";

    private static final Logger log = Logger.getLogger(Inventario.class);
    ...
    public OutputValidaInventario validaSeries(InputValidaArticulo objDatos) {
        OutputValidaInventario objRespuestaSeries = new OutputValidaInventario();
        Connection conn = null;
            ...
            try {
                ...
                if (TOKEN.equals("LOGIN")) {
                    ...
                    objRespuesta = getMensaje(Conf_Mensajes.MSJ_SESION_EXPIRO_12, null, this.getClass().toString(),
                            metodo, null, Conf_Mensajes.ORIGEN_SERVICIOS_OP);
                    objRespuestaSeries.setRespuesta(objRespuesta);
                    ...
                    objRespuestaSeries.setRespuesta(objRespuesta);
                     ...
                     { 
                 		...
                 		CtrlValidaArticulos recurso=new CtrlValidaArticulos();
                 		objRespuestaSeries=recurso.validaSeries(objDatos);
                     }
                     else
                     {
                    	// obteniendo url de servicio
                         log.trace("obteniendo url");
                         url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_VALIDA_SERIES);
                         log.trace("url:" + url);
                         ...
                         if (url == null || url.equals("null") || "".equals(url)) {
                             ...
                             InventarioCliente wsInventario = new InventarioCliente();
                             wsInventario.setServerUrl(url);
                             log.trace("consume servicio");
                             objRespuestaSeries = wsInventario.ValidaSeries(objDatos);
                         }
                     }
        ...
        objRespuestaSeries.setToken(TOKEN);
        return objRespuestaSeries;
    }
}
