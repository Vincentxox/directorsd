...
import com.consystec.sc.sv.ws.metodos.CtrlDevolucion;

public class Devolucion extends ControladorBase {
    ...
    /***
     * M\u00E9todo para aceptar o rechazar art\u00EDculos de una solicitud tipo Devolucion
     * 
     * @param objDatos
     * @return
     */
    public Respuesta aceptarSolicitud(InputAceptaRechazaDevolucion objDatos) {
        Connection conn = null;
        Respuesta objRespuesta = new Respuesta();
        String metodo = "aceptarSolicitud";
        String url = "";
        ...
        if (objRespuesta == null) {
            ...
            try {
                ...
                { 
            		...
            		CtrlDevolucion recurso=new CtrlDevolucion();
            		objRespuesta=recurso.aceptaRechaza(objDatos);
                }
                else
                {
                	 // obteniendo url de servicio
                    log.trace("obteniendo url");
                	 url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_ACEPTASOLICITUD);
                     log.trace("url:" + url);
                     ...
                     if (url == null || url.equals("null") || "".equals(url)) {
                         ...
                         SolicitudCliente wsPDV = new SolicitudCliente();
                         wsPDV.setServerUrl(url);
                         objRespuesta = wsPDV.aceptaDevolucion(objDatos);
                     }
                }
