...
import com.consystec.sc.ca.ws.cliente.DescuentoFSCliente;
...
import com.consystec.sc.sv.ws.metodos.CtrlDescuentoFS;
...
public class DescuentoFS extends ControladorBase{
	
	private static final Logger log = Logger.getLogger(OfertaComercial.class);
	
	public Respuesta validarDatos(InputDescuentoFS objDatos) {
    ...
    public OutputDescuentoFS getDescuentoFS(InputDescuentoFS objDatos) {
        OutputDescuentoFS objRespuestaDescuento = new OutputDescuentoFS();
        Connection conn = null;
        ...
        if (objRespuesta == null) {
            try {
                ...
                { 
            		...
            		CtrlDescuentoFS recurso=new CtrlDescuentoFS();
            		objRespuestaDescuento = recurso.getDescuentoFs(objDatos);
                }
                else
                {
                	// obteniendo url de servicio
                    url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_DESCUENTO_FS);
                    log.trace("url:" + url);
                    if (url == null || url.equals("null") || "".equals(url)) {
                        ...
                        DescuentoFSCliente wsOf = new DescuentoFSCliente();
                        wsOf.setServerUrl(url);
                        objRespuestaDescuento = wsOf.getDescuentoFS(objDatos);
                    }	
                }
