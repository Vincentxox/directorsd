...
import com.consystec.sc.ca.ws.cliente.OfertaCampaniaMovilCliente;
...
public class OfertaCampaniaMovil extends ControladorBase {

    private static final Logger log = Logger.getLogger(OfertaCampaniaMovil.class);
    String TOKEN = "";

    /***
     * Validando que no vengan parametros nulos
     */
    public Respuesta validarDatos(InputOfertaCampaniaMovil objDatos) {
        ...
        if (objDatos.getToken() == null || "".equals((objDatos.getToken()))) {
            objRespuesta = new Respuesta();
    ...
    /**
     * M\u00E9todo para consultar Ofertas o Campanias
     */
    public OutputOfertaCampaniaMovil getOfertaCampania(InputOfertaCampaniaMovil objDatos) {
        OutputOfertaCampaniaMovil objRespuestaOfertaCampania = new OutputOfertaCampaniaMovil();
        Connection conn = null;
            ...
            try {
                ...
                if (TOKEN.equals("LOGIN")) {
                    ...
                    { 
                		...
                		CtrlOfertaCampaniaMovil recurso=new CtrlOfertaCampaniaMovil();
                		objRespuestaOfertaCampania=recurso.getDatos(objDatos , Conf.METODO_GET);
                		 if (objRespuestaOfertaCampania.getOfertaCampania() != null) {
                             for (int i = 0; i < objRespuestaOfertaCampania.getOfertaCampania().size(); i++) {
	                		if (objRespuestaOfertaCampania.getOfertaCampania().get(i)
	                                .getArticulosPromocionales() == null  || objRespuestaOfertaCampania.getOfertaCampania().get(i)
	                                        .getArticulosPromocionales().get(0).getCantArticulos()==null){
	                			   List<InputPromoOfertaCampaniaDet> articulosPromocionales = new ArrayList<InputPromoOfertaCampaniaDet>();
	                               objRespuestaOfertaCampania.getOfertaCampania().get(i)
	                                       .setArticulosPromocionales(articulosPromocionales);
	                		}
                             }
                		 }
                    }
                    else
                    {
                        ...
                        url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(),
                                Conf.SERVICIO_LOCAL_GET_OFERTA_CAMPANIA_MOVIL);
                        log.trace("url:" + url);
                        if (url == null || url.equals("null") || "".equals(url)) {
                            ...
                            OfertaCampaniaMovilCliente wsOfertaCampania = new OfertaCampaniaMovilCliente();
                            ...
                            if (objRespuestaOfertaCampania.getOfertaCampania() != null) {
                                for (int i = 0; i < objRespuestaOfertaCampania.getOfertaCampania().size(); i++) {
                                	...
                                	if(objDatos.getCodArea().equals("502")|| isFullStack(objDatos.getCodArea())){
    	                            	...
    	                            	if (objRespuestaOfertaCampania.getOfertaCampania().get(i)
    	                                        .getArticulosPromocionales() == null) {
    	                                    List<InputPromoOfertaCampaniaDet> articulosPromocionales = new ArrayList<InputPromoOfertaCampaniaDet>();
    	                                    objRespuestaOfertaCampania.getOfertaCampania().get(i)
    	                                            .setArticulosPromocionales(articulosPromocionales);
    	                                }
