...
import com.consystec.sc.ca.ws.cliente.CuentaCliente;
...
public class Cuenta extends ControladorBase {
     ...
     */
    public Respuesta validarDatos(InputCuenta objDatos, int metodo) {
     ...
     */
    public OutputCuenta crearCuenta(InputCuenta objDatos) {
        OutputCuenta objRespuestaWS = new OutputCuenta();
        Connection conn = null;
        Respuesta objRespuesta = new Respuesta();
        String metodo = "crearCuenta";
        String url = "";
        ...
        if (objRespuesta == null) {
            try {
                ...
                { 
            		...
            		CtrlCuenta recurso=new CtrlCuenta();
            		objRespuestaWS=recurso.getDatos(objDatos, Conf.METODO_POST);
                }
                else
                {
                	// obteniendo url de servicio
                    url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_CREA_CUENTA);
                    ...
                    if (url == null || url.equals("null") || "".equals(url)) {
                        ...
                        CuentaCliente wsCuenta = new CuentaCliente();
                        wsCuenta.setServerUrl(url);
                        objRespuestaWS = wsCuenta.creaCuenta(objDatos);
                    }
                }
    ...
    /**
     * M\u00E9todo para modificar Cuentas
     */
    public OutputCuenta modCuenta(InputCuenta objDatos) {
        OutputCuenta objRespuestaWS = new OutputCuenta();
        Connection conn = null;
        Respuesta objRespuesta = new Respuesta();
        String metodo = "modCuenta";
        String url = "";
        ...
        if (objRespuesta == null) {
            try {
                ...
                {
                	 // obteniendo url de servicio
                    url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_MOD_CUENTA);
    ...
    /**
     * M\u00E9todo para obtener informaci\u00F3n Cuentas
     */
    public OutputCuenta getCuenta(InputCuenta objDatos) {
        OutputCuenta objRespuestaWS = new OutputCuenta();
        Connection conn = null;
        Respuesta objRespuesta = new Respuesta();
        String metodo = "getCuenta";
        String url = "";
        log.trace("inicia a validar valores...");
        ...
        if (objRespuesta == null) {
            try {
                ...
                //*/
                     ...
                     {
                    	 // obteniendo url de servicio
                         url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_GET_CUENTA);
                         ...
                         if (url == null || url.equals("null") || "".equals(url)) {
                             ...
                             CuentaCliente wsCuenta = new CuentaCliente();
                             wsCuenta.setServerUrl(url);
                             objRespuestaWS = wsCuenta.getCuenta(objDatos);
                         } 
                     }
