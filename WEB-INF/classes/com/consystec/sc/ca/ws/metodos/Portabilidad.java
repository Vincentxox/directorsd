...
import com.consystec.sc.sv.ws.metodos.CtrlPortabilidad;

public class Portabilidad extends ControladorBase {
	private static final Logger log = Logger.getLogger(OfertaComercial.class);
	String TOKEN = "";
	public Respuesta validarDatos(InputCreaPortabilidad objDatos) {
	    ...
	    if (objRespuesta == null) {
            try {
                ...
                { 
            		...
            		CtrlPortabilidad recurso=new CtrlPortabilidad();
            		objRespuestaPortabilidad = recurso.creaPortabilidad(input);
                }
                else
                {
