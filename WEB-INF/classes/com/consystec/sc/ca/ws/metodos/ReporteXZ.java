...
import com.consystec.sc.sv.ws.metodos.CtrlReporteXZ;

public class ReporteXZ extends ControladorBase {

    private static final Logger log = Logger.getLogger(ReporteXZ.class);
    String TOKEN = "";
     ...
     * @return
     */
    public Respuesta validarDatos(InputReporteXZ objDatos) {
     ...
     */
    public OutputReporteXZ generaReporteXZ(InputReporteXZ objDatos) {
        OutputReporteXZ objRespuestaWS = new OutputReporteXZ();

        Connection conn = null;
        Respuesta objRespuesta = new Respuesta();
        String metodo = "generaReporteXZ";
        String url = "";
            ...
            try {
                ...
                if (TOKEN.equals("LOGIN")) {
                	...
                	if(isFullStack(objDatos.getCodArea())){
                		CtrlReporteXZ recurso = new CtrlReporteXZ();
                		objRespuestaWS=recurso.generarReporte(objDatos);
                				
                	}else{
	                	
	                    // obteniendo url de servicio
	                    url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_REPORTE_XZ);
	                    ...
	                    if (url == null || url.equals("null") || "".equals(url)) {
	                        ...
	                        objRespuestaWS = wsCliente.generaReporteXZ(objDatos);
	                        log.trace("respuesta:" + objRespuestaWS.getRespuesta().getDescripcion());
	                    }
	                }
                }
