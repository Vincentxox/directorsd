...
import com.consystec.sc.ca.ws.cliente.CantInvCliente;
...
public class ConsultaCantInv extends ControladorBase {
    String TOKEN = "";

    private static final Logger log = Logger.getLogger(ConsultaCantInv.class);

    /***
     * Validando que no vengan par\u00E9metros nulos
     */
    public Respuesta validarDatos(InputConsultaCantInv objDatos) {
     ...
     */
    public OutputConsultaCantInv getDatos(InputConsultaCantInv objDatos) {
        OutputConsultaCantInv objRespuestaInventario = new OutputConsultaCantInv();
        Connection conn = null;
            ...
            try {
                ...
                if (TOKEN.equals("LOGIN")) {
                	...
                	if(isFullStack(objDatos.getCodArea()))
                	{
                		...
                		CtrlConsultaCantInv recurso=new CtrlConsultaCantInv();
                	...
                	else
                	{
                        ...
                        url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_GET_CANTINV);
                        log.trace("url:" + url);
                        if (url == null || url.equals("null") || "".equals(url)) {
                            ...
                            CantInvCliente wsInventario = new CantInvCliente();
