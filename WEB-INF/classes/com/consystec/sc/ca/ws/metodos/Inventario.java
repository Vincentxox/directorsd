...
public class Inventario extends ControladorBase {
    String TOKEN = "";
     ...
     */
    public Respuesta validarDatos(InputConsultaInventario objDatos) {
    ...
    public OutputInventario getInventario(InputConsultaInventario objDatos) {
        OutputInventario objRespuestaInventario = new OutputInventario();
        Connection conn = null;
                ...
                if (TOKEN.equals("LOGIN")) {
                    ...
                    objRespuestaInventario.setRespuesta(objRespuesta);
                      ...
                      { 
                  		...
                  		CtrlInventario recurso=new CtrlInventario();
                      ...
                      else
                      {
                          ...
                          url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_GETINVENTARIO);
                          log.trace("url:" + url);
