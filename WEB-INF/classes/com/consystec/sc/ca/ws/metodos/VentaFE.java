...
import com.consystec.sc.ca.ws.cliente.VentaFECliente;
...
public class VentaFE extends ControladorBase{

	 private static final Logger log = Logger.getLogger(VentaFE.class);
	    String TOKEN = "";
	    /***
	     * Validando que no vengan par\u00E9metros nulos
	     */
	    public Respuesta validarDatos(InputVentaFE objDatos) {
	    ...
	    public OutputgetVentaFE getVentaFE(InputVentaFE objDatos) {
	    	OutputgetVentaFE objRespuestaVentas = new OutputgetVentaFE();
	        Connection conn = null;
	            ...
	            try {
	               ...
	               if(TOKEN.contains(Conf_Mensajes.MSJ_TOKEN_INVALIDO_7+"")){ 
	                ...
	                objRespuesta = getMensaje(Conf_Mensajes.MSJ_TOKEN_INVALIDO_7,mensaje,
	                	...
	                	TOKEN="";
	                	objRespuestaVentas.setRespuesta(objRespuesta);
	               }
	                	...
	                	TOKEN="";
			                ...
			                url = Util.getURLWSLOCAL(conn, objDatos.getCodArea(), Conf.SERVICIO_LOCAL_GET_VENTA_FE);
			                log.trace("url:" + url);
			                ...
			                if (url == null || "null".equals(url) || "".equals(url)) {
			                    ...
			                    VentaFECliente wsCliente = new VentaFECliente();
			                    wsCliente.setServerUrl(url);
			                    objRespuestaVentas = wsCliente.getVendedorFE(objDatos);
			                }
		                }
	  	            } catch (SQLException e) {
	                log.error(e,e);
	                ...
	                DbUtils.closeQuietly(conn);
	                objRespuestaVentas.setToken(TOKEN);
	            }
	        } else {
