...
@XmlRootElement(name = "InputOfertaCampaniaMovil")
public class InputOfertaCampaniaMovil {
    @XmlElement
    ...
    @XmlElement
    private List<InputPromoOfertaCampaniaDet> articulosPromocionales;
    ...
    public List<InputPromoOfertaCampaniaDet> getArticulosPromocionales() {
        return articulosPromocionales;
    }
    public void setArticulosPromocionales(List<InputPromoOfertaCampaniaDet> articulosPromocionales) {
