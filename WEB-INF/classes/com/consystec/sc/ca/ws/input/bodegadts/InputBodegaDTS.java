...
@XmlRootElement(name = "InputBodegaDTS")
public class InputBodegaDTS {
    @XmlElement
    ...
    @XmlElement
    private String bodegaVirtualId;
	...
	public String getBodegaVirtualId() {
		return bodegaVirtualId;
	}
	public void setBodegaVirtualId(String bodegaVirtualId) {
		this.bodegaVirtualId = bodegaVirtualId;
	}
