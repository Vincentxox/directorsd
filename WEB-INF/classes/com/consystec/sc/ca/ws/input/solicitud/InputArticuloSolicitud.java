...
@XmlRootElement(name = "InputArticuloSolicitud")
public class InputArticuloSolicitud {
    @XmlElement
    private String codArea;
    @XmlElement
    private String idSolicitudDet;
    @XmlElement
	...
	public String getIdSolicitudDet() {
        return idSolicitudDet;
    }
    public void setIdSolicitudDet(String idSolicitudDet) {
        this.idSolicitudDet = idSolicitudDet;
    }
