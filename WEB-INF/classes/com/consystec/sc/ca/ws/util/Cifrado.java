...
/**
 * Esta clase es la encargada de encriptar y desencriptar una cadena de caracteres 
 * proporcionando una llave unica, con lo cual se logra generar un valor unico por
 * llave y valor de cadena.
 * 
 * @author CONSYSTEC
 *
 */
public class Cifrado  extends ControladorBase{
	...
	/* 
	 * En caso la cadena no tiene la longitud necesaria se complementa con
	 * la variable Keysufix, este es un valor concatenado al final de la cadena 
	 */
	...
	/**
	 * La funcion convierte una cadena con texto comun a una cadena
	 * representada en valor hexadecimal.
	 * @param word Cadena la cual se desea convertir a hexdecimal
	...
	/**
	 * Convierte un arreglo de bytes en una variable String
	 * que contenga un valor hexadecimal
	 * @param b
	...
	/**
	 * Convierte una cadena que contiene un valor en 
	 * hexadecimal a un arreglo de bytes.
	 * @param s
	 * @return byte[]
	 */
