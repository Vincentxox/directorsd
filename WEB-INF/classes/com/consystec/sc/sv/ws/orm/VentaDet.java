...
public class VentaDet implements Cloneable {
    ...
    @XmlElement
    private List<DescuentosSidra> descuentosArticulo;
    ...
    public List<DescuentosSidra> getDescuentosArticulo() {
        return descuentosArticulo;
    }
    public void setDescuentosArticulo(List<DescuentosSidra> descuentosArticulo) {
        this.descuentosArticulo = descuentosArticulo;
    }
